    ...
    export class BrNiuNiuMapPage extends game.gui.base.Page {
        ...
        private showSettleInfo(): void {
            ...
            this._pageHandle.pushOpen({
                ...
                dataSource: { myBet: myBet, myBenefit: myBenefit, allBet: allBet, bankerBenefit: bankerBenefit, bankerHead: this._bankerHead, bankerTxk: this._bankerTXK, bankerName: this._bankerName },
        ...
        private updateBanker(data: number): void {
            ...
            if (bankerUnit) {
                ...
                this._bankerHead = this._game.datingGame.getHeadUrl(bankerUnit.GetHeadImg(), 2);
                this._bankerTXK = this._game.datingGame.getTouXiangKuangUrl(bankerUnit.GetHeadKuangImg(), 2);
